...
namespace MovieViewerProject.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileId = table.Column<int>(type: "int", nullable: false),
                    NumOfTimesWatched = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Watched_", x => x.WatchedId);
                    table.ForeignKey(
                        name: "FK_Watched__Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Watched__Profiles_ProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Watched__MovieId",
                table: "Watched_",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_Watched__ProfileId",
                table: "Watched_",
                column: "ProfileId");
        }
